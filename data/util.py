...
def read_image(path, dtype=np.float32, color=True):
    ...
    the range of its value is`[0, 255]`. If `color = True`, the
    order of the channels is RGB.

    Args:
        path (str): A path of image file.
        dtype: The type of array. The default value is `~numpy.float32`.
        color (bool): This option determines the number of channels.
            If `True`, the number of channels is three. In this case,
...
def resize_bbox(bbox, in_size, out_size):
    ...
    tensor of shape `(R, 4)`, where`R` is the number of
    bounding boxes in the image. The second axis represents attributes of
    the bounding box. They are `(y_{min}, x_{min}, y_{max}, x_{max})`,
...
def crop_bbox(
    ...
    Args:
        ...
        allow_outside_center (bool): If this argument is `False`,
            bounding boxes whose centers are outside of the cropped area
            are removed. The default value is `True`.
        return_param (bool): If `True`, this function returns
    ...
    Returns:
        ...
        returns a tuple whose elements are `bbox, param`.
        `param` is a dictionary of intermediate parameters whose
...
def random_flip(img, y_random=False, x_random=False,
    ...
    Returns:
        ...
        returns an array `out_img` that is the result of flipping.

        If `return_param = True`,
        returns a tuple whose elements are `out_img, param`.
        `param` is a dictionary of intermediate parameters whose
        contents are listed below with key, value-type and the description
        of the value.
