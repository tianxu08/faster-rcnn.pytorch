...
# same with data.voc_dataset.VOC_BBOX_LABEL_NAMES
...
def vis_image(img, ax=None):
    ...
    Args:
        img (~numpy.ndarray): An array of shape `(3, height, width)`.
            This is in RGB format and the range of its value is
            `[0, 255]`.
        ax (matplotlib.axes.Axis): The visualization is displayed on this
            axis. If this is `None` (default), a new axis is created.
...
def vis_bbox(img, bbox, label=None, score=None, ax=None):
    ...
    Args:
        img (~numpy.ndarray): An array of shape `(3, height, width)`.
            This is in RGB format and the range of its value is
            `[0, 255]`.
        bbox (~numpy.ndarray): An array of shape `(R, 4)`, where
            `R` is the number of bounding boxes in the image.
            Each element is organized
            by `(y_{min}, x_{min}, y_{max}, x_{max})` in the second axis.
        label (~numpy.ndarray): An integer array of shape `(R,)`.
            The values correspond to id for label names stored in
            `label_names`. This is optional.
        score (~numpy.ndarray): A float array of shape `(R,)`.
             Each value indicates how confident the prediction is.
             This is optional.
        label_names (iterable of strings): Name of labels ordered according
            to label ids. If this is `None`, labels will be skipped.
        ax (matplotlib.axes.Axis): The visualization is displayed on this
            axis. If this is `None` (default), a new axis is created.
